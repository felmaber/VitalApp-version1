...
public class GruposFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView RVGrupos = (RecyclerView) vista.findViewById(R.id.RVGrupos);
        RVGrupos.setHasFixedSize(true);
        RecyclerListaGrupos adapter = new RecyclerListaGrupos(new String[]{"Grupo Familiar", "Grupo Amigos", "Grupo Trabajo"});
